...
class multicopy(QMainWindow):
    """Create the main window that stores all of the widgets necessary for the application."""

    def __init__(self, parent=None):
        """Initialize the components of the main window."""
        super(multicopy, self).__init__(parent)
        self.resize(1024, 768)
        self.setWindowTitle('multicopy')
        window_icon = pkg_resources.resource_filename('multicopy.images',
    ...
    def file_menu(self):
        ...
        self.open_action.setStatusTip('Open a file into multicopy.')
    ...
    def tool_bar_items(self):
        ...
        open_icon = pkg_resources.resource_filename('multicopy.images',
